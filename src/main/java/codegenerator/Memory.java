 ...
 */
public class Memory {
    private ArrayList<AddressCode> codeBlock;
    ...
    public Memory() {
        codeBlock = new ArrayList<AddressCode>();
    ...
    public int saveMemory() {
        codeBlock.add(new AddressCode());
        return codeBlock.size() - 1;
    }

    public void add3AddressCode(Operation op, Address opr1, Address opr2, Address opr3) {
        codeBlock.add(new AddressCode(op,opr1,opr2,opr3));
    }

    public void add3AddressCode(int i, Operation op, Address opr1, Address opr2, Address opr3) {
        codeBlock.remove(i);
        codeBlock.add(i, new AddressCode(op, opr1, opr2,opr3));
    }
...
class AddressCode {
    ...
    public AddressCode(Operation op, Address opr1, Address opr2, Address opr3) {
        operation = op;
        Operand1 = opr1;
        Operand2 = opr2;
        Operand3 = opr3;
